...
public class ClientMain {
	...
	public static void main(String[] args) throws Exception{
		...
		final int cport = Integer.parseInt(args[0]); // port of listening on
		int timeout = Integer.parseInt(args[1]); //timeout in MILLISECONDS
		...
		if (!downloadFolder.exists()) //downloads folder doesn't exist
